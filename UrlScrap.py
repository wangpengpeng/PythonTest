...
head_url = "https://www.research.net"
# head_url = "https://www.research.net/r/qc_qis?ref=fgdsiv"
headers = {
...
def get_first_url():
    ...
    reaponse = requests.get(head_url, headers)
            ...
            for url2 in urls:
                ...
                if url2_1:
                    if url2_1[0] == "/":
                        ...
                        if url2_1[0:24] == "https://www.xxx.net":
                            url2_1 = url2_1
                            url_list.append(url2_1)
                        else:
                            pass
